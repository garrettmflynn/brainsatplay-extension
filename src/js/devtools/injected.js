...
const id = 'brainsatplay-injection'
...
if (esmonitor) {
    ...
    esmonitor.callback = (path, info, update) => {
            ...
            try {
                ...
                console.warn('[Brains@Play]: Could not pass state', stateInfo, e)
            }
        }
    }
...
const relayId = 'brainsatplay-content-script-relay'
...
const init = () => {
    try {
        ...
        console.warn('[Brains@Play]: Could not initialize states', esmonitor.state, e)
    }
}
